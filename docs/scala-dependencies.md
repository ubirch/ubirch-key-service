...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "client-rest" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "client-rest-cache-redis" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "cmdtools" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "config" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "core" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "model-db" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "model-rest" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "server" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "test-tools" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "util" % "0.11.0-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "utilsNeo4j" % "0.11.0-SNAPSHOT"
)
```

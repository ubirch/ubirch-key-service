...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "client-rest" % "0.7.0"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "model-rest" % "0.7.0"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "test-tools" % "0.7.0"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "utilsNeo4j" % "0.7.0"
)
```

...
function build_container() {
  ...
  if [ -z $GO_PIPELINE_LABEL ]; then
      ...
      docker build --pull -t ubirch/ubirch-key-service:v$GO_PIPELINE_LABEL .
  else
      # build with GoCD
      docker build --pull -t ubirch/ubirch-key-service:v$GO_PIPELINE_LABEL --build-arg GO_PIPELINE_NAME=$GO_PIPELINE_NAME \
...
function container_tag_stable () {
    docker pull ubirch/ubirch-key-service:v$GO_PIPELINE_LABEL
    docker tag ubirch/ubirch-key-service:v$GO_PIPELINE_LABEL ubirch/ubirch-key-service:stable
    docker push ubirch/ubirch-key-service:stable

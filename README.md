...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "model-rest" % "0.1.4"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "test-tools" % "0.1.4"
)
```

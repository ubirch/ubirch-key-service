...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "client-rest" % "0.1.8"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "model-rest" % "0.1.8"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.key" %% "test-tools" % "0.1.8"
)
```
